...
Make the missing design assumptions explicit (effect sizes, outcome variability, correlation of repeated measures, dropout, allocation, and multiplicity strategy). Perform a sensitivity analysis over at least three plausible values for the primary-outcome SD and treatment effect, and show whether each option meets both the 90% power and $1M budget constraints. Clearly distinguish costs for randomized, retained, and MRI-assessed participants.
