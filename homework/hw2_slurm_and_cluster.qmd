...
Your full experiment will be a grid of 5 (n) x 4 (alpha) x 4 (rho) = 80 unique scenarios. For each scenario, you'll run 1000 replications.  Evaluate both bias and standard error. Run your simulation on the cluster using a slurm array job
